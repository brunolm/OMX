...
var jscolor = {
    ...
    bindClass : 'manager-colorpicker', // class name
    binding : true, // automatic binding via <input class="...">
    preloading : false, // use image preloading?

    colorUpdated: function(val) {
    },
    ...
    bind : function() {
        var elements = document.querySelectorAll("." + jscolor.bindClass);
        ...
        for (var i in elements)
        {
            ...
            {
                try {
                element.color = new jscolor.color(element, "fff");
                }catch(ex){}
            }
        }
    ...
    loadImage : function(filename) {
        if(!jscolor.imgLoaded[filename]) {
            ...
            jscolor.imgLoaded[filename].src = jscolorImages.loadImage64(filename);
        }
    },
    ...
    color : function(target, prop) {
        ...
        function drawPicker(x, y) {
            ...
            p.padM.style.backgroundImage = "url('"+jscolorImages.loadImage64("cross.gif")+"')";
            p.padM.style.backgroundRepeat = "no-repeat";
            p.sldM.style.backgroundImage = "url('"+jscolorImages.loadImage64("arrow.gif")+"')";
            p.sldM.style.backgroundRepeat = "no-repeat";
            p.pad.style.backgroundImage = "url('"+jscolorImages.loadImage64(padImg)+"')";
